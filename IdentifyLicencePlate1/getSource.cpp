...
//图片文件等资源路径
char* getSource::IMG_PATH="../img_src/licencePlate5.jpg";
string getSource::FILE_PATH="../file_src/mat.txt";
string getSource::IMG_TRAIN_PATH="../img_model";
string getSource::IMG_PLATE_PATH="../img_model/plate";
...
string getSource::getImagePlatePath()
{
	return IMG_PLATE_PATH;
}

void getSource::setImagePlatePath(string file_path)
{
	IMG_PLATE_PATH=file_path;
}
